class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :password_confirmation, :remember_me, :username, :zip_code, :default_provider, :latitude, :longitude#, :admin
  ...
  def to_s
    "#{self.email}, #{self.zip_code}, #{self.default_provider}"
  end
